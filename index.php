...
<section id="one" class="wrapper style1 align-center">
	<div class="container">
		<header>
			<h2>Smart Planting Advisor</h2>
			<p> Say goodbye to guesswork and hello to precision farming.
				Our personalized AI recommendations are like having a virtual agricultural expert right by your side</p>
		</header>
		<div class="row 200%">
